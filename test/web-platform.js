...
class DOMException extends Error {
  get name() {
    if (!(this instanceof DOMException)) {
      throw new TypeError("Wrong branding");
    }
    return super.name;
  }
}
...
for (const prop in exceptionProps) {
  DOMException[prop] = exceptionProps[prop];
  DOMException.prototype[prop] = exceptionProps[prop];
}
